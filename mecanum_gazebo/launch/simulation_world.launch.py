...
def generate_launch_description():
    ...
    mecanum_launch_file_dir = os.path.join(
        get_package_share_directory("mecanum_gazebo"), "launch"
    )

    control_params_file = os.path.join(
        get_package_share_directory("mecanum_description"), "config", "controllers.yaml"
    )
    ...
    world = os.path.join(
        get_package_share_directory("mecanum_gazebo"), "arena", "arena.world"
    )
