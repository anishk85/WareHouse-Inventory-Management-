    ...
    try {
      ...
      imu_subscriber_ = node_->create_subscription<sensor_msgs::msg::Imu>(
        ...
        [this](const sensor_msgs::msg::Imu::SharedPtr msg) {
          // Store latest IMU angular velocity (yaw rate) for sensor fusion
          imu_angular_velocity_z_ = msg->angular_velocity.z;
          //todo :check this @@@@@
          
          // Optional: Store full IMU data if needed for advanced fusion
          // imu_linear_acceleration_x_ = msg->linear_acceleration.x;
          // imu_linear_acceleration_y_ = msg->linear_acceleration.y;
        });
