...
if intersection_pt is not None and final_r1_start is not None:
    ...
    # Line from Rack 1 Far End to Intersection
    cv2.line(output_img, (s1x, s1y), (ix, iy), (255, 0, 255), 2)
    
    # Line from Rack 2 Far End to Intersection
...
cv2.imwrite('map_with_buffers.png', output_img) # Save the result
print("Result saved as 'map_with_buffers.png'")
# cv2.waitKey(0)
