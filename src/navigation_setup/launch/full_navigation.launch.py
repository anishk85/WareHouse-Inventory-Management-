"""
Complete navigation launch - starts Gazebo, robot, and Nav2 together
"""
import os
...
def generate_launch_description():
    ...
    # 2. Odom TF Publisher (starts after 8 seconds)
    ...
    # 3. CMD_VEL to Mecanum converter (NEW - starts after 8 seconds)
    ...
    # 5. Nav2 Bringup (starts after 12 seconds)
    ...
    # 6. RViz (starts after 15 seconds)
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
    ...
    # Start map->odom TF after 9 seconds (before AMCL takes over)
    ld.add_action(TimerAction(
        period=9.0,
        actions=[map_odom_tf]
    ))
