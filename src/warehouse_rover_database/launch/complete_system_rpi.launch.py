#!/usr/bin/env python3
"""
Warehouse Rover Complete Launch File - RPi Camera Version
Launches: RPi Camera Module 3 + QR Detector + Inventory Database

Topic Flow:
  RPi Camera -> /image_raw -> QR Detector -> /qr_detection -> Inventory Database
"""
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                parameters=[{
                    ...
                    'format': 'BGR888',  # Critical fix for RPi Camera Module 3
                }],
                remappings=[
